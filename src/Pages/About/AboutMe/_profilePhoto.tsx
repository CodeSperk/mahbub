  ...
  return (
    <div className="lg:w-1/2 space-y-6 mx-auto text-center lg:ml-6 mb-6">
      <div className="relative w-60 md:w-80 h-72 md:h-96 group">
        ...
        <div className="absolute inset-0 bg-page-bg rounded-lg transition-transform duration-500 ease-in-out rotate-[8deg] group-hover:rotate-0 border-2 shadow-lg shadow-purple-300" />

        {/* Straight card that becomes angled on hover */}
        <div className="absolute inset-0 bg-page-bg rounded-lg transition-transform duration-500 ease-in-out group-hover:rotate-[8deg] border-2" />
